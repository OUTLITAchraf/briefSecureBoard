...
import { fetchUser, userLogin } from '../../../features/AuthSlice';
...
function Login() {
    ...
    const Login = async (data) => {
        ...
        try {
            ...
            console.log('Error while dispatch userLogin :', error);
        }
    }
    return (

        <form class="form_container" onSubmit={handleSubmit(Login)}>
            ...
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" type="text" class="input_field" {...register('email')} />
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" type="password" class="input_field" id="password_field" {...register('password')} />
            </div>
            <button title="Sign In" type="submit" class="sign-in_btn">

                <span>
                    {
                        login.isLoading ? 'Signin...' : 'Sign in'
                    }
                </span>
            </button>
            {login.error ? <p className='login_error'>{login.error}</p> : null}
            <div class="separator">
                <hr class="line" />
                <span>Or</span>
                <hr class="line" />
