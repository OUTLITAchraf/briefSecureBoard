...
function Register() {
    ...
    const signup = async (data) => {
        ...
        try {
            ...
            console.log('Error while dispatch register user :', error);
        }
    }
    return (
        <form class="form_container" onSubmit={handleSubmit(signup)}>
            ...
            <div class="input_container">
                ...
                {errors.name && <div className="login_error">{errors.name.message}</div>}
                ...
                <input placeholder="examplename..." title="Inpit title" name="input-name" type="text" class="input_field" id="name_field" {...register('name')} />
            </div>
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" type="text" class="input_field" id="email_field" {...register('email')} />
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field" {...register('password')} />
            </div>
            <div class="input_container">
                <label class="input_label" for="password_field">Password Confirmation</label>
                {errors.password_confirmation && <div className="login_error">{errors.password_confirmation.message}</div>}

                <input placeholder="Password" title="Inpit title" type="password" class="input_field" id="password_field"  {...register('password_confirmation')} />
            </div>
            <button title="Sign up" type="submit" class="sign-in_btn">
                <span>
                    {
                        auth.register.isLoading ? 'loading...' : 'Signup'
                    }
                </span>
            </button>
            {
                auth.register.error ? <p className='login_error'>{auth.register.error}</p> : null
            }
        </form>
    )
}
